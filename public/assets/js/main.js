  ...
  var Model = (function () {
    ...
    function viewer(rec) {
      ...
      viewerKit.load().then(function () {
        ...
        mv.setAttribute('camera-orbit', rec.cameraOrbit || '45deg 75deg 105%');
        mv.setAttribute('field-of-view', rec.fov || '38deg');
        mv.setAttribute('tone-mapping', rec.toneMapping || 'agx');
        mv.setAttribute('min-camera-orbit', 'auto auto 5%');
        mv.setAttribute('max-camera-orbit', 'auto auto 400%');
        mv.setAttribute('shadow-intensity', rec.shadowIntensity || '1.4');
        mv.setAttribute('shadow-softness', rec.shadowSoftness || '0.4');
        mv.setAttribute('exposure', rec.exposure || '1.05');
        mv.setAttribute('environment-image', rec.envImage || 'neutral');
